...
<div class="container">
                ...
                <div class="form">
                    <form action="">
                        <table class="table table-bordered print-table">
                            ...
                            <tbody>
                                <tr>
                                    <th colspan="6">UNIT/VEHICLE NAME:
                                    <input type="text" name="othersLocation" value=""
                                                        style="border: none; background-color: transparent; border: none;">
                                ...
                                <tr>
                                    <th colspan="14">Type of Call:
                                        ...
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="callType[]"
                                                value="fire">
                                            Fire
                                            <input type="checkbox" class="form-check-input" name="callType[]"
                                            ...
                                            <td>
                                                <label class="form-check-label">
                                                    ...
                                                    <li> <input type="checkbox" class="form-check-input"
                                                            name="weather[]" value="windy"> Windy
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" class="form-check-input" name="weather[]"
    ...
    <th colspan="12" style="height: 670px;">
        <textarea style="height: 670px; width: 100%; overflow-wrap: break-word; border: none; resize: none;" placeholder="Enter your text here"></textarea>
    </th>
</tr>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6" class="checkbox-group">
                                            <label class="form-check-label">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="form-check-input"
                                                        name="interventions[]" value="angel"> High Angel Rescue
                                                    <input type="checkbox" class="form-check-input"
                                    ...
                                    <tr>
                                        <td><input type="text" name="othersLocation" value=""
